    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 align-self-center">
                ...
                @if (view()->hasSection('action-btn-link') && view()->hasSection('action-btn-text'))
                    <button onclick="location.href = '@yield('action-btn-link')'" class="btn green">
                        @yield('action-btn-text')
                    </button>
                @endif
