...
<head>
    ...
    <title>Laravel - Revanced By Priyank Modi </title>
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                <main class="mt-6">
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                        <a href="https://github.com/priyank2006/laravel-revanced" id="docs-card"
                            ...
                            <div class="relative flex items-center gap-6 lg:items-end">
                                <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                    ...
                                    <div class="pt-3 sm:pt-5 lg:pt-0">
                                        <h2 class="text-xl font-semibold text-black dark:text-white"> Laravel - Revanced
                                            By Priyank Modi </h2>
                                    </div>
                                </div>
                        ...
                        <a href="https://laracasts.com"
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white"> Beautiful Error Pages
                                </h2>

                                <p class="mt-4 text-sm/relaxed">
                                    Added Beautiful error pages to override laravel default error pages.
                                </p>
                            </div>
                ...
                <footer class="py-16 text-center text-sm text-black dark:text-white/70">
                    Laravel - Revanced By Priyank Modi v{{ Illuminate\Foundation\Application::VERSION }} (PHP
                    v{{ PHP_VERSION }})
                </footer>
            </div>
        </div>
